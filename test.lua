...
local Library = {
	Themes = {
		...
		Vindicate = {
        	...
        	Custom = {
			Main = Color3.fromRGB(unpack(uiColor1)),
			Secondary = Color3.fromRGB(unpack(uiColor2)),
			Tertiary = Color3.fromRGB(unpack(uiColor3)),
...
function Library:create(options)
	...
	local homeButtonIcon = homeButton:object("ImageLabel", {
		...
		Image = "http://www.roblox.com/asset/?id=17652341208",
		Theme = {ImageColor3 = "StrongText"}
	})
	...
	creditsTab:credit{Name = "FinalRuze", Description = "Owner of Vindicate"}
