...
local xnmcvzxkcjaaaplayerloop = false
...
tab:toggle({
   ...
   if Value == true then
        xnmcvzxkcjaaaplayerloop = true
        while xnmcvzxkcjaaaplayerloop do
            EquipSpray()
            task.wait(0.4)
            if infinityGauntlet == "All" then
                for _, v in pairs(game.Players:GetPlayers()) do
                    if v ~= game.Players.LocalPlayer then -- Skip executing the function on yourself
                        local xnmcvzxkcjaaaplayertarget = v
                        xnmcvzxkcjaaaplayerfunc(xnmcvzxkcjaaaplayertarget)
                        task.wait()
                    end
                end
            else
                local xnmcvzxkcjaaaplayertarget = findPlayerByName(infinityGauntlet)
                if xnmcvzxkcjaaaplayertarget then
                    xnmcvzxkcjaaaplayerfunc(xnmcvzxkcjaaaplayertarget)
                else
