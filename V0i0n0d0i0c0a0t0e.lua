...
function fehowfunc()
game:GetService("Players").LocalPlayer.Character.SprayPaint.Remote:FireServer(0, Enum.NormalId.Back, 6.331, (fehowtarget.Character.LeftHand), fehowtarget.Character.LeftHand.CFrame * CFrame.new(0, 3, 0))
...
local Toggle = Tabs.Premium:AddToggle("", {Title = "test222", Default = false })
