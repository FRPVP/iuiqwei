...
local function ToggleKnifeScript(enabled)
    local lp = game.Players.LocalPlayer
...
local Toggle = Tabs.Premium:AddToggle("", {Title = "Knife Script", Default = false })

Toggle:OnChanged(function()
    print("Knife Toggle changed:", Options.KnifeToggle.Value)
    ToggleKnifeScript(Options.KnifeToggle.Value)
end)

Options.KnifeToggle:SetValue(false)
