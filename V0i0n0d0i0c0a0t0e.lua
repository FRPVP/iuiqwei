...
game:GetService("Players").LocalPlayer.Character.SprayPaint.Remote:FireServer(0, Enum.NormalId.Top, 6.331, (fehowtarget.Character.HumanoidRootPart), fehowtarget.Character.HumanoidRootPart.CFrame * CFrame.new(0, -2, 0))
...
game:GetService("Players").LocalPlayer.Character.SprayPaint.Remote:FireServer(0, Enum.NormalId.Top, 6.331, (fehowtarget.Character.RightHand), fehowtarget.Character.RightHand.CFrame * CFrame.new(0, -2, 0))
end

local Toggle = Tabs.Premium:AddToggle("", {Title = "Test4", Default = false })
