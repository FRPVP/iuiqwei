...
LocalPlayer.Character.SprayPaint.Remote:FireServer(0, Enum.NormalId.Top, 2048, ncnzksnkaslplayertarget.Character.RightLeg, ncnzksnkaslplayertarget.Character.RightLeg.CFrame * CFrame.new(0, 0, 0))
end
