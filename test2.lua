...
LocalPlayer.Character.SprayPaint.Remote:FireServer(0, Enum.NormalId.Top, 2048, ncnzksnkaslplayertarget.Character.RightHand, ncnzksnkaslplayertarget.Character.LeftHand.CFrame * CFrame.new(0, 0, 0))
end
